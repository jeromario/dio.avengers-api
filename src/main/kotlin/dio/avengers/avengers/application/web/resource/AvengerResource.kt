...
import dio.avengers.avengers.application.web.resource.response.AvengerResponse
import dio.avengers.avengers.domain.avenger.AvengerRepository
        ...
        )
{
    ...
    @DeleteMapping("/{id}")
    fun delete(@PathVariable("id") id: Long) = repository.getDetail(id)?.let {
        repository.delete(it.id!!).let {
